    ...
    return (
        <Block id="contentImageOne">
            <div className="container mx-auto xl:max-w-6xl relative">
                {animation && <div className="absolute -top-10 sm:top-0 right-0 z-10 transform translate-x-1/2 -translate-y-1/2 rotate-12 ">
                ...
                <div className={`flex flex-wrap items-center -mx-4 ${!reverse && 'flex-row-reverse'}`}>
                    <div className="px-4 w-full lg:w-1/2">
                        <div className={`lg:max-w-lg py-10 lg:px-10 ${!reverse && 'ml-auto'}`}>
